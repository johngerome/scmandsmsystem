...
class Examples extends CI_Controller
{
	...
	function index()
	{
		$this->_example_output((object)array('output' => '', 'js_files' =>
			array(), 'css_files' => array()));
	}
	...
	function customers_management()
	{
		...
		$crud->display_as('salesRepEmployeeNumber', 'from Employeer')->display_as('customerName',
			'Name')->display_as('contactLastName', 'Last Name');
	...
	function film_management()
	{
		...
		$crud->set_relation_n_n('category', 'film_category', 'category',
			'film_id', 'category_id', 'name');
		$crud->unset_columns('special_features', 'description');

		$crud->fields('title', 'description', 'actors', 'category', 'release_year',
