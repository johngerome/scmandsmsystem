...
<div class="onecolumn" >
 <div class="header"><span ><span class="ico  gray list"></span>
  Re Order Products in all Branch
 </span> </div>                  
                  <div class="clear"></div>
                  <div class="content" >
                   <div id="uploadTab">
                      <div class="tab_container" >
                         ...
                         <div>
                      	  <select class=""  name="branch_id" id="branch_id" onchange="load_prod_re_order();">
                            ...
                            <input type="hidden" id="current_url" value="<?php echo current_url() ?>"/>   
                             ...
                             <?php foreach($product as $row): ?>
                                  <tr>
                                    ...
                                    <td><b><a href="<?php echo base_url().'product/view/'.$row->branch_id.'/re-order-products.html' ?>"><?php echo $row->branch_name ?></a></b></td>
                                    <td><?php echo $this->product_model->count_re_order_product($row->branch_id) ?></td>
                                  </tr>
                            <?php endforeach; ?>
