...
<div class="clear"></div>
<div class="onecolumn" >
 <div class="header"><span ><span class="ico  gray list"></span>Available Products in <?php echo $branch_name ?></span> </div>                  
                  <div class="clear"></div>
                  <div class="content" >
                   ...
                   <div id="uploadTab">
                      <div class="tab_container" >
                          ...
                          <div class="load_page">
                              ...
                              <a class="uibutton" href="<?php echo base_url().'product/availability' ?>" title="Cancel"   >Go Back</a>
                              </div>
