...
<div class="onecolumn" >
 <div class="header"><span ><span class="ico  gray list"></span>
  Back Order Products in all Branch
 </span> </div>                  
                  <div class="clear"></div>
                  <div class="content" >
                   <div id="uploadTab">
                            ...
                            <input type="hidden" id="current_url" value="<?php echo current_url() ?>"/>   
                             ...
                             <?php foreach($product as $row): ?>
                                  <tr>
                                    ...
                                    <td><b><a href="<?php echo base_url().'product/view/'.$row->branch_id.'/back-order-products.html' ?>"><?php echo $row->branch_name ?></a></b></td>
                                    <td><?php echo $this->product_model->count_back_order_product($row->branch_id) ?></td>
                                  </tr>
                            <?php endforeach; ?>
