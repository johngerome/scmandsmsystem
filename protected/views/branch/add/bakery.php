...
<input type="submit" class="button blue-button" id="button" value="<?php echo $this->lang->line('add_new_branch') ?>" name="member"/>
Or <?php echo anchor('branch/bakery','Cancel','Class="link" title="Cancel Adding Branch" '); ?>
</form>
</div>
</center>