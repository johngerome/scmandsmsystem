 ...
 */
$config['replacer'] = array('user' => 'User Accounts','branch' =>'Branch Manager', 'member' => 'Members > Managed Members','create' => 'Add New Member','login_to_continue' => '', 'account' => array('dashboard|my control panel'), 'dashboard' => 'my dashboard');
