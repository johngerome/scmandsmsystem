...
/*	this.set_value		=		function ( buffer ,_value) {
	...
	*/
	...
	this.exe_form		=		function( params ) {
		...
		CJAX.HTTP_REQUEST_INSTANCE.setRequestHeader('X-Requested-With', 'CJAX FRAMEW0RK 4.0');
			...
			if(CJAX.HTTP_REQUEST_INSTANCE.readyState) {
				if(CJAX.HTTP_REQUEST_INSTANCE.readyState < 4) {
					...
					case 404:
						...
						break;
					case 414:
						CJAX.msg.error('Error: the data sent was too large.');
						break;
					case 500:
